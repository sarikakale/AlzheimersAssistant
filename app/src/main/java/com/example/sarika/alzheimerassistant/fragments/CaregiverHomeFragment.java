 ...
 * {@link CaregiverHomeFragment.CaregiverHomeCallbacks} interface
...
public class CaregiverHomeFragment extends Fragment {
    ...
    private CaregiverHomeCallbacks mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof CaregiverHomeCallbacks) {
            mListener = (CaregiverHomeCallbacks) context;
        } else {
     ...
     */
    public interface CaregiverHomeCallbacks {
