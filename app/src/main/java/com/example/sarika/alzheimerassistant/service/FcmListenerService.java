...
import com.example.sarika.alzheimerassistant.util.NotificationsUtil;
...
public class FcmListenerService extends FirebaseMessagingService {
    ...
    NotificationsUtil notificationUtils;
    ...
    private void handleNotification(String message, String title) {
        if (!NotificationsUtil.isAppIsInBackground(getApplicationContext())) {
           /* // app is in foreground, broadcast the push message
            Intent pushNotification = new Intent(Util.PUSH_NOTIFICATION);
