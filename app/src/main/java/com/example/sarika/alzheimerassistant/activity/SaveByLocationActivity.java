...
public class SaveByLocationActivity extends AppCompatActivity implements LocationTracker.LocationCallback,
    ...
    @BindView(R.id.locationReminderMessage)
    EditText locationReminderMessage;
    private String reminderMessage;

    //Final Details to be submitted
    private LocationReminder detailToSubmit;
    private static final String TAG = SaveByLocationActivity.class.getSimpleName();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_save_by_location);
        ButterKnife.bind(this);
        //detailToSubmit = new GeoFenceDetail();
        detailToSubmit = getIntent()
                .getParcelableExtra(Util.LOCATION_REMINDER_DETAIL_PARCEL_KEY);
    ...
    private void setupSubmitButton(){
        ...
        Log.d(TAG,detailToSubmit.getLocation().toString());
        submitBtn.setOnClickListener(v -> {
            //Make Volley request
            String url = String.format("%s/smartReminder/addReminder", Util.getServerUrl());
            reminderMessage = locationReminderMessage.getText().toString() +
                    ". On "+new Date();
            reminderMessage = reminderMessage.trim();
            detailToSubmit.setReminderMessage(reminderMessage);
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST,
                ...
                Toast.makeText(this, "Error on saving Reminder",
                        Toast.LENGTH_LONG).show();
                })
                {
    ...
    public void startMonitoring(){
        ...
        googleMap.moveCamera(CameraUpdateFactory.newLatLng(new LatLng(detailToSubmit.getLocation().getLat(),
                detailToSubmit.getLocation().getLng())));
    ...
    public void onCameraIdle() {
        ...
        com.example.sarika.alzheimerassistant.bean.Location location=new com.example.sarika.alzheimerassistant.bean.Location();
        location.setLat(currPosition.target.latitude);
        location.setLng(currPosition.target.longitude);
        detailToSubmit.setLocation(location);
